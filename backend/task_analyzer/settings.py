...
This configuration is production-ready and works with Railway deployment.
"""
...
# Security Settings - Uses environment variables in production
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR.parent / 'frontend'],  # Serve frontend from Django
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
