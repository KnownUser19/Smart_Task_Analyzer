...
Smart Task Analyzer - Production Configuration
"""
...
# Database - SQLite for simplicity (Railway provides PostgreSQL if needed)
DATABASES = {
    'default': {
...
STATICFILES_DIRS = [
    BASE_DIR.parent / 'frontend',  # Include frontend files
]
